...
test('UI Elements', async({page})=>{
    ...
    const UserRadioBtn= page.locator(".radiotextsty").click();
    await expect(page.locator(".radiotextsty")).toBeChecked();
    await expect(page.locator("#okayBtn")).toBeVisible();
    await page.locator("#okayBtn").click();
    await expect(page.locator(".radiotextsty")).not.toBeChecked();
